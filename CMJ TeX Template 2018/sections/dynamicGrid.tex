...
\begin{figure}[hp]
    \centering
    \subfloat[]{\label{fig:twoFreeStrings}{ \includegraphics[width=0.8\columnwidth]{twoFreeStringGridMove}}}\\
    \subfloat[]{\label{fig:twoFreeStringsGridMoveZoomed}{ \includegraphics[width=0.8\columnwidth]{twoFreeStringGridMoveZoomed}}}\\
    \subfloat[]{\label{fig:twoFreeStringsGridZoomed2}{ \includegraphics[width=0.8\columnwidth]{twoFreeStringGridMoveZoomed2}}}
